        ...
        <form action="" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="jumlah" name="nama_barang"
                    placeholder="Masukkan Nama Barang" min="1" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="kategori" id="" class="form-select">
                    ...
                    <option value="Perankat Elektronik">Perankat Elektronik</option>
                    <option value="Perankat Multimedia">Perankat Multimedia</option>
                    <option value="Perankat Kantoran">Perankat Kantoran</option>
                    <option value="Perankat Audio">Perankat Audio</option>
                    <option value="Perankat Konektivitas">Perankat Konektivitas</option>
                    <option value="Perankat Jaringan">Perankat Jaringan</option>
                    <option value="Perankat Penyimpanan">Perankat Penyimpanan</option>
