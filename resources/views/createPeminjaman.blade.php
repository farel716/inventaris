    ...
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            @if (Auth::guard('loginSiswa')->check())
                <div class="mb-3">
                    <input type="hidden" name="nisn" value="{{ Auth::guard('loginSiswa')->user()->username }}">
                </div>
            @elseif (Auth::guard('admin')->check())
            <div class="mb-3">
                <input type="hidden" name="nisn" value="{{ Auth::guard('admin')->user()->username }}">
            </div>
            @endif
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="dikembalikan" name="dikembalikan"
